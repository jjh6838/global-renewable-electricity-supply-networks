...
#SBATCH --output=outputs_per_country/logs/parallel_19_%j.out
#SBATCH --error=outputs_per_country/logs/parallel_19_%j.err
#SBATCH --mail-type=END,FAIL

set -euo pipefail
cd "$SLURM_SUBMIT_DIR"

echo "[INFO] Starting parallel script 19/40 (T4) at $(date)"
echo "[INFO] Processing 2 countries in this batch: ETH, GEO"
