...
#SBATCH --output=outputs_per_country/logs/parallel_20_%j.out
#SBATCH --error=outputs_per_country/logs/parallel_20_%j.err
#SBATCH --mail-type=END,FAIL

set -euo pipefail
cd "$SLURM_SUBMIT_DIR"

echo "[INFO] Starting parallel script 20/40 (T4) at $(date)"
echo "[INFO] Processing 2 countries in this batch: GHA, IRQ"
